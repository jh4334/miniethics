...
const CARDS = [
  { e: '🎤', title: '유명 가수의 신곡 발표 사진', clues: ['🖐️ 손가락이 6개다', '💡 그림자 방향이 제각각', '❓ 출처 표시가 없다'], real: false, why: 'AI가 만든 딥페이크 사진! 손가락과 그림자가 단서였어요.' },
  ...
  { e: '📱', title: '연예인 목소리 전화 "돈 보내줘"', clues: ['🎙️ 목소리는 진짜 같음', '💸 갑자기 돈을 요구함', '⏰ 지금 당장 하라고 재촉'], real: false, why: 'AI 딥보이스 사기! 목소리가 같아도 이상한 부탁은 꼭 확인!' },
  ...
  mount(host, ctx) {
    ...
    function finish() {
      ...
      ctx.finish({
        ...
        msg: `${CARDS.length}장 중 ${correct}장을 정확히 판별했어요!<br>단서 확인 습관이 명탐정을 만들어요 🔎`,
      });
    }
